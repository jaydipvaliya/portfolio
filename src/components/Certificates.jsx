...
const certificates = [
  { title: 'Jaipur Cybrathon 2025',         issuer: 'Unstop',      date: '2025', link: 'https://unstop.com/certificate-preview/05422511-0d9c-4c0f-b4d5-848562687297', img: 'https://d8it4huxumps7.cloudfront.net/uploads/certificates/05422511-0d9c-4c0f-b4d5-848562687297.png', type: 'Hackathon',   accent: '#4CC9F0' },
  { title: "Odoo × Adani Hackathon '26",    issuer: 'Odoo/Adani',  date: '2026', link: 'https://unstop.com/certificate-preview/55383f5e-8f27-40bb-a72c-ec85870c248c', img: 'https://d8it4huxumps7.cloudfront.net/uploads/certificates/55383f5e-8f27-40bb-a72c-ec85870c248c.png', type: 'Hackathon',   accent: '#FF6B9D' },
  { title: 'K Hacks 3.0',                   issuer: 'Unstop',      date: '2024', link: 'https://unstop.com/certificate-preview/4643e5b8-f46b-424e-a344-def73d8044eb', img: 'https://d8it4huxumps7.cloudfront.net/uploads/certificates/4643e5b8-f46b-424e-a344-def73d8044eb.png', type: 'Hackathon',   accent: '#6BCB77' },
  { title: 'Online Round — Code Clash',     issuer: 'Unstop',      date: '2024', link: 'https://unstop.com/certificate-preview/010b0ef5-40f2-4674-9be3-b12dbdfffab5', img: 'https://d8it4huxumps7.cloudfront.net/uploads/certificates/010b0ef5-40f2-4674-9be3-b12dbdfffab5.png', type: 'Competition', accent: '#FFD84D' },
];
