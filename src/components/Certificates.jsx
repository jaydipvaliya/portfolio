...
const certificates = [
  ...
  { title: 'SoloLearn C programming',     issuer: 'SoloLearn',      date: '2026', link: 'https://www.sololearn.com/certificates/CC-LGRXXPYT', img: 'https://res.cloudinary.com/dg4c3rylm/image/upload/w_700,q_auto,f_auto/v1776188234/sololearn-c_ufbuj2.png', type: 'Course', accent: '#FFD84D', description: 'Mastered core programming fundamentals including pointers, memory management, and data structures through rigorous practical exercises.' },
